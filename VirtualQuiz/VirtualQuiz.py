    ...
    def update(self, cursor, bboxes):
        for x, bbox in enumerate(bboxes):
            ...
            if x1< cursor[0] <x2 and y1< cursor[1] <y2:
                self.userAns = x + 1
                cv2.rectangle(img, (x1, y1), (x2, y2), (0, 255, 2), cv2.FILLED)
...
while True:
    ...
    if qNo < qTotal:
        mcq = mcqList[qNo]
        img, bbox = cvzone.putTextRect(img, mcq.question, [50, 50],
                                       1, 2, offset=20, border=2)
        img, bbox1 = cvzone.putTextRect(img, mcq.choice1, [50, 150],
                                       1, 2, offset=20, border=2)
        img, bbox2 = cvzone.putTextRect(img, mcq.choice2, [250, 150],
                                       1, 2, offset=20, border=2)
        img, bbox3 = cvzone.putTextRect(img, mcq.choice3, [50, 250],
                                       1, 2, offset=20, border=2)
        img, bbox4 = cvzone.putTextRect(img, mcq.choice4, [250, 250],
                                       1, 2, offset=20, border=2)
